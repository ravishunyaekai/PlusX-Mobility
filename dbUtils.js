 ...
 * 
 **/
export const oldgetPaginatedData = async ({
...
export const getPaginatedData = async ({
  ...
  // Apply JOIN clause if necessary
  // join state st on  msl.state_id = st.state_id
   const joinClause = joinTable && joinCondition ? ` ${joinType} ${joinTable} ON ${joinCondition}` : '';
...
export const formatFloatInQuery = (field) => {
