...
export const chargerBooking = asyncHandler(async (req, resp) => {
    ...
    const { rider_id, user_name, country_code, contact_no, address, latitude, longitude, parking_number = '', parking_floor = '', vehicle_id, slot_date, slot_time, slot_id, service_feature, service_price = 0, address_id, device_name = '', coupon_code = '', battery_percent = 0, package_id
    } = mergeParam(req);
    console.log("\nchargerBooking req.body", req.body);
