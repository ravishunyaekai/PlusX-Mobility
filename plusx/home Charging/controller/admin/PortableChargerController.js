...
export const chargerDetails = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Mobile EV Charging Details fetched successfully!"],
...
export const invoiceList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Mobile EV Charging Invoice List fetched successfully!"],
            data: result.data,
            total_page: result.totalPage,
            total: result.total,
        });
...
export const invoiceDetailsOld = async (req, resp) => {
    ...
    `, [invoice_id]);
        ...
        return resp.json({
            message: ["Mobile EV Charging Invoice Details fetched successfully!"],
            data: data,
            status: 1,
            code: 200,
        });
...
export const invoiceDetails = async (req, resp) => {
    try {
        ...
        return resp.json({
            message: [
                "Mobile EV Charging Invoice Details fetched successfully!"
            ],
            data,
            status: 1,
            code: 200
...
export const slotList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Mobile EV Charging Slot List fetched successfully!"],
            data: formattedData,
            total_page: result.totalPage,
            total: result.total,
        });
...
export const slotDetails = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Mobile EV Charging Slot Details fetched successfully!"],
            data: slotDetails,
...
export const assignBooking = async (req, resp) => {
    ...
    try {
        ...
        emailQueue.addEmail(rsa.email, 'PlusX Electric App: Booking Confirmation for Your Portable Charging Booking', htmlDriver);


        return resp.json({
            status: 1,
            code: 200,
            message: "You have successfully assigned Charging booking."
        });
...
export const adminCancelPCBooking = asyncHandler(async (req, resp) => {
    ...
    emailQueue.addEmail(checkOrder.rider_email, `Booking Cancellation Confirmation - PlusX Electric Mobile EV Charging Service (Booking ID : ${booking_id} )`, html);
...
export const customerChargerBookingList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Customer Charging Booking List fetched successfully!"],
            data: result.data,
            total_page: result.totalPage,
            total: result.total,
        });
...
export const failedChargerBookingList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status: 1,
            code: 200,
            message: ["Failed Charging Booking List fetched successfully!"],
            data: result.data,
            total_page: result.totalPage,
            total: result.total,
        });
