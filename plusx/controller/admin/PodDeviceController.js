...
export const podAreaAssignList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status     : 1,
            code       : 200,
            message    : ["Charging Assign Area List fetch successfully!"],
            data       : result.data,
            total_page : result.totalPage,
            total      : result.total,
        });
...
export const podAreaInputList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status     : 1,
            code       : 200,
            message    : ["Mobile EV Charging Input History List fetch successfully!"],
            data       : result.data,
            total_page : result.totalPage,
            total      : result.total,
        });
...
export const podAreaBookingList = async (req, resp) => {
    try {
        ...
        return resp.json({
            status     : 1,
            code       : 200,
            message    : ["Mobile EV Charging Booking History List fetch successfully!"],
            data       : result.data,
            total_page : result.totalPage,
            total      : result.total,
        });
